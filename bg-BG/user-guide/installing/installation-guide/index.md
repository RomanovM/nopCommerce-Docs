...
author: AndreiMaz
uid: bg-BG/user-guide/installing/installation-guide/index
---
...
Before you begin the install, ensure that you and your web host have the [minimum requirements to run nopCommerce.](xref:bg-BG/user-guide/installing/technology-system-requirements)

> [!TIP] For more information on hosting selection guidelines, visit [this page.](xref:bg-BG/user-guide/installing/installation-guide/hosting-provider)
...
> [!TIP] For more information on IIS, visit [this page.](xref:bg-BG/user-guide/installing/installation-guide/installing-IIS)
...
- [Hosting providers](xref:bg-BG/user-guide/installing/installation-guide/hosting-provider)
- [Installing Internet Information Services (IIS)](xref:bg-BG/user-guide/installing/installation-guide/installing-IIS)
- [Known Issues and Solutions](xref:bg-BG/user-guide/installing/installation-guide/known-issues-and-solutions)
