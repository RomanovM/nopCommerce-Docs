...
> [!NOTE] The appropriate message template is disabled by default, you can change it in [Message Templates](xref:user-guide/marketing/content/message-templates.md) section
...
On the **Vendor attributes** section, select Vendor attributes. Learn more about vendor attributes and how to create them [here](xref:user-guide/configuring/settingup/customers/vendors/settings.md).
...
[Vendor settings](xref:user-guide/configuring/settingup/customers/vendors/settings.md)
