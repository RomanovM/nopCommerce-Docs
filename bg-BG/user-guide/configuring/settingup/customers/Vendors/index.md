...
> [!NOTE] The appropriate message template is disabled by default, you can change it in [Message Templates](xref: en-US/user-guide/marketing/content/message-templates) section
