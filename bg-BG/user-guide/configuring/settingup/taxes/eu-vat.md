...
author: AndreiMaz
uid: bg-BG/user-guide/configuring/settingup/taxes/eu-vat
---
...
Make sure that all products have a tax category assigned to them on their [product pages](xref:bg-BG/user-guide/running/product-management/products/adding-products/index).
