...
title: Tax
author: AndreiMaz
uid: bg-BG/user-guide/configuring/settingup/taxes/tax/index
---
...
* [Avalara tax provider](xref: bg-BG/user-guide/configuring/settingup/taxes/tax/methods/avalara)
* [Manual (Fixed or By Country/State/Zip)](xref: bg-BG/user-guide/configuring/settingup/taxes/tax/methods/manual)
...
Tax categories are assigned to products on [product editing pages](xref: bg-BG/user-guide/running/product-management/products/adding-products/index). Taxes can also be applied to **shipping fees** and **payment method** additional fees.
