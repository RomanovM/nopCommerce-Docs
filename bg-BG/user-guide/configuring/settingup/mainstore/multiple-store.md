...
author: AndreiMaz
uid: bg-BG/user-guide/configuring/settingup/mainstore/multiple-store
---
...
Different [themes](xref: bg-BG/user-guide/configuring/design/installing-theme) can also be configured for different stores.
