...
author: AndreiMaz
uid: bg-BG/user-guide/running/order-management/orders/index
---
...
* View the **list of shipments**. Click **View** beside the shipment to view its details. The shipment information window will be displayed: ![shipment-details](_static/shipment-details.jpeg)
