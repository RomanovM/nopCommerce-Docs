...
title: Discounts
author: AndreiMaz
uid: bg-BG/user-guide/marketing/promotional/discounts/index
---
...
- How to [install plugins](xref: bg-BG/user-guide/configuring/system/plugins)
...
- [Common types of discounts](xref: bg-BG/user-guide/marketing/promotional/discounts/common-type-of-discounts)
