...
- How to [install plugins](xref:user-guide/configuring/system/plugins.md)
...
- [Common types of discounts](xref:user-guide/marketing/promotional/discounts/common-type-of-discounts.md)
