...
title: Vendors
author: AndreiMaz
uid: en-US/user-guide/configuring/setting-up/customers/vendors/index
---
# Vendors
...
On the **Vendor attributes** section, select Vendor attributes. Learn more about vendor attributes and how to create them [here](xref:en-US/user-guide/configuring/setting-up/customers/vendors/settings).
...
[Vendor settings](xref:en-US/user-guide/configuring/setting-up/customers/vendors/settings)
