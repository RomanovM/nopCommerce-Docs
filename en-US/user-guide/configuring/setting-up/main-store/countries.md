...
> [!NOTE]
> This list is used only when you have several stores configured. For further details refer to [Stores](xref:en-US/user-guide/configuring/setting-up/main-store/multiple-store).
