...
Make sure that all products have a tax category assigned to them on their [product pages](xref: user-guide/running/product-management/products/adding-products/index.md).
