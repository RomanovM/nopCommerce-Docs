...
Once the site is deployed you have to install nopCommerce. Please read more about it [here](xref:ru/user-guide/installing/installation-guide/index) ("Installation process").
