...
For further details, refer to the [document](xref:developer/plugins/payment-method.md) (recommended to be used only by developers).
...
* [Square](xref:user-guide/configuring/settingup/payments/methods/square.md)
* [Qualpay](xref:user-guide/configuring/settingup/payments/methods/qualpay.md)
* [Manual Processing (Credit Card)](xref:user-guide/configuring/settingup/payments/methods/manual-processing.md)
* [Purchase order](xref:user-guide/configuring/settingup/payments/methods/purchase-order.md)
* [PayPal Standard](xref:user-guide/configuring/settingup/payments/methods/paypal-standard.md)
