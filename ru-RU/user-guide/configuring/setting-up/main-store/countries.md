...
title: Countries
author: AndreiMaz
uid: ru-RU/user-guide/configuring/setting-up/main-store/countries
---
# Countries
...
> [!NOTE]
> This list is used only when you have several stores configured. For further details refer to [Stores](xref:ru-RU/user-guide/configuring/setting-up/main-store/multiple-store).
