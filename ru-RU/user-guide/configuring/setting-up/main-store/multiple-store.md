...
author: AndreiMaz
uid: ru-RU/user-guide/configuring/setting-up/main-store/multiple-store
---
...
Once the stores have been setup and configured, you can define your entities for each store. This is done in the Stores section of the details pages for each of the following: [Products](xref:ru-RU/user-guide/running/product-management/products/index), [Categories](xref:ru-RU/user-guide/running/product-management/categories), [Manufacturers](xref:ru-RU/user-guide/running/product-management/manufacturers), [Languages](xref:ru-RU/user-guide/configuring/setting-up/main-store/languages), [Currencies](xref:ru-RU/user-guide/configuring/setting-up/payments/currencies), [Message templates](xref:ru-RU/user-guide/marketing/content/message-templates), [Blogs](xref:ru-RU/user-guide/marketing/content/blog/index), [News](xref:ru-RU/user-guide/marketing/content/news/index), [Topics](xref:ru-RU/user-guide/marketing/content/topics).
...
Different [themes](xref:ru-RU/user-guide/configuring/design/installing-theme) can also be configured for different stores.
