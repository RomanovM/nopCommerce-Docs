...
title: Vendors
author: AndreiMaz
uid: ru-RU/user-guide/configuring/setting-up/customers/vendors/index
---
# Vendors
...
> [!NOTE]
> The appropriate message template is disabled by default, you can change it in [Message Templates](xref:ru-RU/user-guide/marketing/content/message-templates) section
...
On the **Vendor attributes** section, select Vendor attributes. Learn more about vendor attributes and how to create them [here](xref:ru-RU/user-guide/configuring/setting-up/customers/vendors/settings).
...
[Vendor settings](xref:ru-RU/user-guide/configuring/setting-up/customers/vendors/settings)
