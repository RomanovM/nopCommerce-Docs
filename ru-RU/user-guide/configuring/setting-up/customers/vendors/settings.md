...
author: AndreiMaz
uid: ru-RU/user-guide/configuring/setting-up/customers/vendors/settings
---
# Vendor settings
...
* [Setting up Customers](xref:ru-RU/user-guide/configuring/setting-up/customers/index)
