...
title: Tax
author: AndreiMaz
uid: ru-RU/user-guide/configuring/setting-up/taxes/tax/index
---
# Tax
...
* [Avalara tax provider](xref:ru-RU/user-guide/configuring/setting-up/taxes/tax/methods/avalara)
* [Manual (Fixed or By Country/State/Zip)](xref:ru-RU/user-guide/configuring/setting-up/taxes/tax/methods/manual)
...
Tax categories are assigned to products on [product editing pages](xref:ru-RU/user-guide/running/product-management/products/adding-products/index). Taxes can also be applied to **shipping fees** and **payment method** additional fees.
