...
author: AndreiMaz
uid: ru-RU/user-guide/running/product-management/catalog-settings
---
# Catalog settings
...
- **Ignore ACL rules** (sitewide) turns off the [ACL rules](xref:ru-RU/user-guide/configuring/setting-up/customers/acl) configured for entities.
