...
- [Configure general store settings](xref: ru-RU/user-guide/configuring/settingup/mainstore/index)
- [Configure payment methods](xref: ru-RU/user-guide/configuring/settingup/payments/payment-methods)
- [Configure shipping options](xref: ru-RU/user-guide/configuring/settingup/shipping/index)
- Configure users list: create [different groups](xref:user-guide/configuring/settingup/customers/customer-roles) of users, give them [separate access to areas of your site](xref: ru-RU/user-guide/configuring/settingup/customers/acl), offers and so on.
...
nopCommerce enables you to run more than one store using one interface from a single nopCommerce installation and manage all admin operations from a single panel. Learn [here](xref: ru-RU/user-guide/configuring/settingup/mainstore/multiple-store) how to set up several stores.
