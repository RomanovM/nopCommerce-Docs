...
Before you begin the install, ensure that you and your web host have the [minimum requirements to run nopCommerce.](xref: en-US/user-guide/installing/technology-system-requirements)

> [!TIP] For more information on hosting selection guidelines, visit [this page.](xref: en-US/user-guide/installing/installation-guide/hosting-provider)
...
> [!TIP] For more information on IIS, visit [this page.](xref: en-US/user-guide/installing/installation-guide/installing-IIS)
