...
author: RomanovM
uid: ru-RU/ru-RU/user-guide/installing/installation-guide/index
---
...
Before you begin the install, ensure that you and your web host have the [minimum requirements to run nopCommerce.](xref:ru-RU/user-guide/installing/technology-system-requirements)

> [!TIP] For more information on hosting selection guidelines, visit [this page.](xref:ru-RU/user-guide/installing/installation-guide/hosting-provider)
...
> [!TIP] For more information on IIS, visit [this page.](xref:ru-RU/user-guide/installing/installation-guide/installing-IIS)
...
- [Hosting providers](xref:ru-RU/ru-RU/user-guide/installing/installation-guide/hosting-provider)
- [Installing Internet Information Services (IIS)](xref:ru-RU/ru-RU/user-guide/installing/installation-guide/installing-IIS)
- [Known Issues and Solutions](xref:ru-RU/ru-RU/user-guide/installing/installation-guide/known-issues-and-solutions)
