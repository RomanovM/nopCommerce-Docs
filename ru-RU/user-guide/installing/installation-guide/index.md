...
> [!TIP]
> For more information on hosting selection guidelines, visit [this page.](xref:ru-RU/user-guide/installing/installation-guide/hosting-provider)
...
> [!TIP]
> For more information on IIS, visit [this page.](xref:ru-RU/user-guide/installing/installation-guide/installing-IIS)
