...
author: AndreiMaz
uid: ru-RU/user-guide/installing/azure
---
...
Once the site is deployed you have to install nopCommerce. Please read more about it [here](xref:ru-RU/user-guide/installing/installation-guide/index) ("Installation process").
