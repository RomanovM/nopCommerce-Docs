...
author: AndreiMaz
uid: ru-RU/developer/plugins/plugin-with-data-access
---
...
- [Developer tutorials](xref:ru-RU/developer/tutorials/index)
- [Updating an existing entity. How to add a new property.](xref:ru-RU/developer/tutorials/update-existing-entity)
- [How to write a plugin for nopCommerce 4.20](xref:ru-RU/developer/plugins/how-to-write-plugin-4.20)
